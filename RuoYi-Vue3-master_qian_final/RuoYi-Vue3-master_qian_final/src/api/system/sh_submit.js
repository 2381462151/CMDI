...
export function submitToBackend(formData) {
  return request({
    url: '/system/sh_submit/submit',
    method: 'post',
    data: formData,
...
export function getSubmissionInfo(data) {
  return request({
    url: '/system/sh_submit/getSubmissionInfo',
    method: 'get'
  })
}
export function fetchrejectOptions(param, identity) {
  // 创建一个对象并填充数据
  const payload = {
    param: param,
    identity: identity
  ...
  // 发送请求
  return request({
    url: '/system/sh_submit/fetchrejectOptions'+ payload, // 假设这是你的后端 API URL
    method: 'get'
    // data: payload, // 直接传递对象，axios 会自动将其序列化为 JSON
    // headers: { 'Content-Type': 'application/json' } // 指定 Content-Type 为 application/json
  });
}
export function fetchApprovalOptions(param, identity) {
  // 创建一个对象并填充数据
  const payload = {
    param: param,
    identity: identity
  ...
  // 发送请求
  return request({
    url: '/system/sh_submit/fetchApprovalOptions'+ payload, // 假设这是你的后端 API URL
    method: 'get'
    // data: payload, // 直接传递对象，axios 会自动将其序列化为 JSON
    // headers: { 'Content-Type': 'application/json' } // 指定 Content-Type 为 application/json
  });
...
// 使用示例
export function fetchSubmit_formOptions(param, identity) {
  // 创建一个对象并填充数据
  const payload = {
    param: param,
    identity: identity
  ...
  // 发送请求
  return request({
    url: '/system/sh_submit/fetchSubmit_formOptions'+ payload, // 假设这是你的后端 API URL
    method: 'get'
    // data: payload, // 直接传递对象，axios 会自动将其序列化为 JSON
    // headers: { 'Content-Type': 'application/json' } // 指定 Content-Type 为 application/json
  });
